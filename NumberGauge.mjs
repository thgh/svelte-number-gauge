...
/* NumberGauge.html generated by Svelte v3.0.0-alpha25 */
...
function instance($$self, $$props, $$invalidate) {
  ...
  let degrees;
	...
	$$self.$$.update = ($$dirty = { rotate: 1, value: 1, degrees: 1, arrows: 1, String: 1, parseInt: 1 }) => {
		if ($$dirty.rotate || $$dirty.value) {
			rotate = (100 - value) * 1.8; $$invalidate('rotate', rotate);
		}
		if ($$dirty.degrees || $$dirty.arrows || $$dirty.String || $$dirty.parseInt) {
			degrees = arrows
        ? String(arrows)
            .split(',')
