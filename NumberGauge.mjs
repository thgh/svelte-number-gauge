...
class SvelteComponent {
	...
	$set(values) {
		if (this.$$) {
			const { ctx, set, not_equal: not_equal$$1 } = this.$$;
			set(values);

			for (const key in values) {
				if (not_equal$$1(ctx[key], values[key])) {
					ctx[key] = values[key];
					make_dirty(this, key);
				}
			}
...
/* NumberGauge.html generated by Svelte v3.0.0-alpha10 */
...
function create_fragment(component, ctx) {
	var div5, text0, div4, div0, text1, div1, text2, div2, text3, div3, text4, current;
...
function instance($$self, $$props, $$invalidate) {
  ...
  let degrees;
	...
	$$self.$$.set = $$props => {
		...
		if ('arrows' in $$props) arrows = $$props.arrows;
	};

	$$self.$$.update = ($$dirty = { value: 1, arrows: 1 }) => {
		if ($$dirty.value) {
